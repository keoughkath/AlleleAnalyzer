...
pams = pd.read_csv('/pollard/data/projects/AlleleAnalyzer_data/pam_beds_hg19/pams_hg19_sorted.bed',
...
for cas in cas_to_colors.keys():
    ...
    pams.query('cas_ == @cas')[['chrom','start','stop','cas_','blah','strand',
      'start_','stop_','color_']].to_csv(f'/pollard/data/projects/AlleleAnalyzer_data/pam_beds_hg19/ucsc_browser/{cas}_ucsc.bed',
