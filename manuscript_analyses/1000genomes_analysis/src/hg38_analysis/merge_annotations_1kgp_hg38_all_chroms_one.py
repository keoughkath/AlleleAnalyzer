...
store = pd.HDFStore(f'/pollard/data/projects/AlleleAnalyzer_data/1kgp_data/hg38_analysis/1kgp_annotated_variants_by_chrom/1kgp_hg38_annots_all.h5',
	complib='blosc', complevel=9)

for chrom in list(range(1,23)):
	df = pd.read_hdf(f'/pollard/data/projects/AlleleAnalyzer_data/1kgp_data/hg38_analysis/1kgp_annotated_variants_by_chrom/chr{chrom}_annotated.h5')
