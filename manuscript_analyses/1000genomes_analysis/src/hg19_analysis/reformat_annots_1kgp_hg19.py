...
in_dir = '/pollard/data/projects/AlleleAnalyzer_data/1kgp_data/hg19_analysis/1kgp_annotated_variants_by_chrom'
out_dir = '/pollard/home/kathleen/projects/AlleleAnalyzer/manuscript_analyses/1000genomes_analysis/dat'
...
# for chrom in [8,22]:
	chrom=str(chrom)
	print(chrom)
	annot_variants=pd.read_hdf(f'{in_dir}/chr{chrom}_annotated.h5','all').drop(columns=['chrom','pos','ref','alt']).reset_index(drop=True)
