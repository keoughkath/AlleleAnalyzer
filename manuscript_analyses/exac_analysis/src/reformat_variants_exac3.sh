#!/bin/bash
#$ -S /bin/bash
#$ -o /netapp/home/kathleen/exac_gens/logs/
#$ -e /netapp/home/kathleen/exac_gens/logs/
#$ -j y
#$ -cwd
#$ -l mem_free=4G
#$ -l arch=linux-x64
...
echo $SGE_TASK_ID
export locus=`sed "${SGE_TASK_ID}q;d" /pollard/home/kathleen/projects/AlleleAnalyzer/manuscript_analyses/exac_analysis/dat/exac_regions.bed`
echo $locus
