...
store = pd.HDFStore(f'/pollard/data/projects/AlleleAnalyzer_data/wtc_data/hg19/wtc_single_targ_5kb/{chrom}_results.h5')
...
for gene in genes:
	fpath = f'/pollard/data/projects/AlleleAnalyzer_data/wtc_data/hg19/wtc_single_targ_5kb/{chrom}_results/{gene}.h5'
