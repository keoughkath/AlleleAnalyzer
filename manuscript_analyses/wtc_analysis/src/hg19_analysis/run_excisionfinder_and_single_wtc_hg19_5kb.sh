#!/bin/bash
#$ -S /bin/bash
#$ -o /netapp/home/kathleen/excisionfinder_wtc_hg19_5kb_s/
#$ -e /netapp/home/kathleen/excisionfinder_wtc_hg19_5kb_s/
#$ -j y
#$ -cwd
#$ -l mem_free=6G
#$ -l scratch=1G
