#!/bin/bash
#$ -S /bin/bash
#$ -o /netapp/home/kathleen/excisionfinder_wtc_hg19_5kb/logs/
#$ -e /netapp/home/kathleen/excisionfinder_wtc_hg19/logs/
#$ -j y
#$ -cwd
#$ -l mem_free=4G
#$ -l arch=linux-x64
