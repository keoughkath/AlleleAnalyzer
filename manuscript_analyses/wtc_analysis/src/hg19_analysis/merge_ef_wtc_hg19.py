...
store = pd.HDFStore(f'/pollard/data/projects/AlleleAnalyzer_data/wtc_data/hg19/wtc_excisionfinder_results/{chrom}_ef_results.h5')
...
for gene in genes:
	fpath = f'/pollard/data/projects/AlleleAnalyzer_data/wtc_data/hg19/wtc_excisionfinder_results/{chrom}_ef_results/{gene}.h5'
