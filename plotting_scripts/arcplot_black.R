...
p = ggraph(lout) +
  ...
  theme(panel.background = element_rect(fill = 'black', colour = 'black'),
        plot.title = element_text(size=18, face="italic", family='sans', color='white'),
        legend.text=element_text(size=12, family='sans', hjust=0, color='white'),
        legend.title=element_text(size=12, family='sans', hjust=0, color='white'),
        axis.ticks = element_line(color='grey20'),
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
        axis.title.y = element_blank(),
        axis.title.x = element_text(family = 'sans', size=12, color='white'),
