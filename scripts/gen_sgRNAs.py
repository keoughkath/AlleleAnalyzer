...
Usage:
    gen_sgRNAs.py [-ch] <gens_file> <targ_file> <locus> <pams_dir> <ref_fasta> <out_dir> <cas_types> <guide_length> [<gene_vars>] [--crispor] [<ref_gen>]
...
def main(args):
    ...
    out.to_csv(out_dir + 'guides.tsv', sep='\t', index=False)
    print('Done.')
