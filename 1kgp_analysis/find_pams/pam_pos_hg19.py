...
hg19 = Fasta('/pollard/home/kathleen/ref_dat/ref_genomes/grch37/grch37.fa',as_raw=True)
...
for cas in cas_list:
	...
	savestr_for = 'hg19_chr_pams_again/chr'+str(chrom)+'_'+str(cas) + '_pam_sites_for.npy'
	savestr_rev = 'hg19_chr_pams_again/chr'+str(chrom)+'_'+str(cas) + '_pam_sites_rev.npy'
...
np.save('hg19_chr_pams_again/chr'+str(chrom)+'_'+'cpf1_pam_sites_for.npy',for_starts)
np.save('hg19_chr_pams_again/chr'+str(chrom)+'_'+'cpf1_pam_sites_rev.npy',rev_starts)